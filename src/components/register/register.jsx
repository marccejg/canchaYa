...
function Register() {
  ...
  return (
    <div className="register-container d-flex justify-content-center align-items-center vh-14 0">
      <div className="card shadow-lg p-4 card-custom">
        <div className="card-body">
          <div className='Titulo'>
          <h2 className="text-center">Sotware Para Clubes</h2>
          <h6 className="text-center mb-4">Completa el siguiete formularop para formar parte de nuestra red de clubes.</h6>
          </div>
          <p></p>
           <p></p>
            ...
            <div className="row mb-3">
              <div className="col-md-8 position-relative">
                ...
                <input
                  ...
                  className="form-control form-control-lg input-with-icon"
                  id="razonSocial"
                  placeholder="Ej: Soy Xeneize Futbool 5"
          ...
          <h5 className="text-center mt-2 mb-2">Nos pondremos en contacto con usted a la brevedad</h5>
